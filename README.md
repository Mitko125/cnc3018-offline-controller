# Промени за запускане на процесор с 64K flash genericSTM32F103C8

- [x] Това вече пуснах в моя процесор. За да се побере махнах USB в софтуера и в 'platformio.ini'. Постигнах 81.3% flash в release. В debud 92.5%. Не мога да дебъгвам през уарта, но мога през дебъгера на ST-LINK/V2.

## надолу е оригинала който беше не като README.md а в измислен формат README.adoc
